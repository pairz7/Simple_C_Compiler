...
Reserved = ['int', 'long', 'short', 'float', 'double', 'char', 'bool', 'unsigned', 'signed', 'const', 'void', 'volatile',
            ...
            'break', 'return', 'default', 'typedef', 'auto', 'register', 'extern', 'static', 'sizeof']
